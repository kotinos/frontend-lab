...
Eleven self-contained UI exercises: static HTML/CSS/JS demos, two Vite + React apps, and one A-Frame scene. Shared **unit-tested** helpers live in `packages/core`; vanilla demos mirror that behavior in the browser without a bundler.
...
| Script | Purpose |
|--------|---------|
| `npm test` | `@frontend-lab/core` + landing + three Vitest suites |
